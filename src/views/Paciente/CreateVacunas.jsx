...
const CreateVacunas = () => {
  ...
  const formularioValidacion = yup.object().shape({
      ...
      tipo: yup
          .string()
          .required('Tipo de vacuna requerida'),
      dosis: yup
          .string()
          .required('Dosis requerida'),
      peso: yup
          .number()
                              ...
                              <VStack space={4} mt="5">
                                  <FormControl isInvalid={'nombre' in errors}>
                                      ...
                                      <Input _focus={styles.inputSeleccionado}
                                          ...
                                          InputLeftElement={<Icon as={<MaterialCommunityIcons name="needle" />}
                                  ...
                                  <FormControl isInvalid={'tipo' in errors}>
                                      <FormControl.Label _text={styles.labelInput}>Tipo:</FormControl.Label>
                                      <Select minWidth="200" accessibilityLabel="Seleccione Tipo de Vacuna" placeholder="Seleccione tipo de vacuna" onValueChange={handleChange('tipo')}
                                          selectedValue={values.tipo}
                                          _selectedItem={{
                                              bg: "teal.600",
                                              endIcon: <CheckIcon size={5} />
                                          }} mt="1">
                                          <Select.Item label="Distemper (Moquillo)" value="Distemper" />
                                  ...
                                  <FormControl isInvalid={'raza' in errors}>
                                      <FormControl.Label _text={styles.labelInput}>Dosis:</FormControl.Label>
                                      <Input _focus={styles.inputSeleccionado}
                                          placeholder='Digite Dosis de Vacuna'
                                          InputLeftElement={<Icon as={<MaterialCommunityIcons name="eyedropper" />}
                                              size={5} ml="2" color="muted.400" />}
                                          value={values.raza}
                                  ...
                                  <FormControl onTouchStart={() => showMode('date')}>
                                      <FormControl.Label _text={styles.labelInput}>Próxima dosis:</FormControl.Label>
